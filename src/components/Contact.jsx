...
function Contact() {
  ...
  return (
    <div
      className="relative flex  flex-col items-center justify-center  mx-auto p-15 md:px-20 lg:px-32 w-full overflow-hidden bg-fixed bg-cover bg-no-repeat text-gray-100"
    ...
    >
      <div className="container">
        ...
        <div className="relative z-10 w-full">
          <h2 className="text-2xl sm:text-4xl text-center font-bold mb-2  text-center">
            Contact{" "}
          ...
          >
            ...
            <div className="w-full text-left flex flex-col ">
              ...
              <textarea
                ...
                maxLength={350}
                placeholder="message"
                className="placeholder:capitalize  rounded  border h-[150px] resize-none border-gray-300 py-3 px-4 mt-2"
              />
            </div>
